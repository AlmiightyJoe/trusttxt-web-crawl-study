...
# Wikipedia category used as the source for European Journalism organizations
CATEGORY_URL = "https://en.wikipedia.org/wiki/Category:Journalism_organizations_in_Europe"
...
def main():
    ...
    with open("media_orgs_eu.csv", "w", newline="", encoding="utf-8") as f:
    ...
    with open("seeds_media_orgs_eu.txt", "w") as f:
        for d in domains:
            f.write(d + "\n")
